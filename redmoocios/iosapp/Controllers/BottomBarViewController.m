...
//    CGFloat barHeight = [self minimumInputbarHeight];
//    CGFloat y = self.view.frame.size.width - barHeight;
//    CGFloat width = self.view.frame.size.width;
//    [_editingBar setFrame:CGRectMake(0, self.view.frame.size.width - barHeight, self.view.frame.size.width, barHeight)];
//    NSLog(@"1:x:%f-------y:%f",self.editingBar.frame.origin.x,self.editingBar.frame.origin.y);
//    NSLog(@"1:width:%f-------height:%f",self.editingBar.frame.size.width,self.editingBar.frame.size.height);
